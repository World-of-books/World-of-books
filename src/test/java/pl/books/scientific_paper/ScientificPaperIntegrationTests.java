...
public class ScientificPaperIntegrationTests {
    ...
    void removing_existing_paper_should_return_code_ok_and_dto() throws Exception {
        ...
        long id = 2L;
        authorRepository.save(new AuthorEntity());
        ScientificPaperEntity scientificPaper = new ScientificPaperEntity("Test", "Test", Set.of(new AuthorEntity(1L)), FieldOfStudy.ASTRONOMY, "Test university", true, 123, LocalDate.of(2023, 1, 1));
