...
class ScientificPaperControllerTest {
    ...
    void get_scientific_paper_by_id_should_return_response_OK_and_response_body_of_found_paper() throws Exception {
        //given
        Long id = 99L;
        ScientificPaperDTO scientificPaperDTO = new ScientificPaperDTO(id, "Test", "Test", new ArrayList<>(), FieldOfStudy.ASTRONOMY.name(), "Test university", true, 123, LocalDate.of(2022, 12, 12).toString());
    ...
    void adding_scientific_paper_with_no_authors_should_return_bad_request() throws Exception {
        //given
        ScientificPaperDTO scientificPaperDTO = new ScientificPaperDTO(null, "test", "test", new ArrayList<>(), "astronomy", "string", true, 123, "1999-10-10");
    ...
    void adding_proper_scientific_paper_should_return_code_200_and_dto() throws Exception {
        //given
        ScientificPaperDTO scientificPaperDTO = new ScientificPaperDTO(112L, "Test", "Test", List.of(new ScientificPaperAuthorDTO(1L)), "astronomy", "Test university", true, 123, "1999-10-10");
    ...
    void removing_existing_paper_should_return_code_ok_and_dto() throws Exception {
        //given
        long id = 12L;
        ScientificPaperDTO scientificPaperDTO = new ScientificPaperDTO(id, "Test", "Test", List.of(new ScientificPaperAuthorDTO(1L)), "astronomy", "Test university", true, 123, "1999-10-10");
