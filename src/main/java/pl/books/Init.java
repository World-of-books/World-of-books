...
import pl.books.book.BookRepository;
...
public class Init {
    ...
    public void runList() {
        ...
        bookRepository.save(ogniemIMieczem);
        ...
        bookRepository.save(panWolodyjowski);
        ...
        bookRepository.save(javaPrzewodnik);
        ...
        bookRepository.save(javaPodstawy);
